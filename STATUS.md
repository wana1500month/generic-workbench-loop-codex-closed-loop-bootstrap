...
- Current-thread is now the default foreground surface, but planner / contract-review / generator-plan / eval same-thread enhancement parity is still pending; the controller currently records explicit runtime warnings for those skipped nested enhancement paths.
