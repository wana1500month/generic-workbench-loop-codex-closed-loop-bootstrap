...
- Keep generated-local kernel wiring drift and external adapter drift fail-closed for now: those can surface a proposal and approval boundary, but they do not rewrite adapter kernels in place without a later migration slice.
