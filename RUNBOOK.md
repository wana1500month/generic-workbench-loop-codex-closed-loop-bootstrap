...
- `npm run validate:quick`: short deterministic front-door and productization gate for intent, intake, discovery, readiness, evaluation policy, scorecard output, non-web adapter-plan defaults, and project-kind fixtures. Use this for fast local iteration before the heavier loop suites.
