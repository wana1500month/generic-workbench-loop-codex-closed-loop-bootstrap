...
- Keep kernel wiring drift, boundary breaks, and external adapter drift fail-closed for now: those still reopen contract negotiation, but they do not rewrite adapter kernels in place without an explicit future migration surface.
