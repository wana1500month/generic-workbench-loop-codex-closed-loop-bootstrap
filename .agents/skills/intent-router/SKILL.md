---
name: intent-router
description: Route a generic Codex workbench request into product-intake, harness-design, run-resume, or evaluator-tuning before planning or implementation.
---
