import { buildOperatorSurfaceArtifact, writeOperatorSurfaceArtifacts } from "../operator-surface.js";
...
import { buildTransportStateArtifact, transportRuntimeWarningsForMode } from "../transport-mode.js";
export const resolveRuntimeSurfaceState = (state, input) => ({
    ...state,
    ...
    decisionOptions: input?.decisionOptions !== undefined
...
export const writeLoopOperatorSurface = async (input) => {
    ...
    if (input.transportMode !== "app-server") {
        await writeTransportStateArtifact(input.transportStatePath, buildTransportStateArtifact({
            runId: input.runId,
    ...
    await writeOperatorSurfaceArtifacts({
        ...
        artifact: buildOperatorSurfaceArtifact({
            ...
            attentionRequired: writeInput?.attentionRequired ?? state.attentionRequired,
            ...
            autoResumeEligible: writeInput?.autoResumeEligible ?? state.autoResumeEligible,
            ...
            activeResponsePath: writeInput?.activeResponsePath ?? state.activeResponsePath,
            ...
            recommendedCommand: writeInput?.recommendedCommand ?? state.recommendedCommand,
            session,
...
//# sourceMappingURL=runtime-surface-writer.js.map