...
export const transportProtocolPathForRun = (runDirectory, transportMode) => join(runDirectory, "runtime", `${transportMode}-protocol.md`);
...
`;
    const modeSpecific = input.transportMode === "current-thread"
