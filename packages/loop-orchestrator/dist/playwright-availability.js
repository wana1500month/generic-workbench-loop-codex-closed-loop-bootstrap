...
const appendLimited = (current, chunk) => (current + chunk.toString()).slice(-outputLimit);
export const probePlaywrightCoreImport = async () => {
...
export const assertPlaywrightCoreImportAvailable = async () => {
    const result = await probePlaywrightCoreImport();
    if (!result.ok) {
        throw new Error(result.reason);
    }
};
//# sourceMappingURL=playwright-availability.js.map