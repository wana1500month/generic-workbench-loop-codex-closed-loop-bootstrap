export type HarnessFocusArea = "planner_clarity" | "contract_testability" | "artifact_handoff" | "patch_authority" | "qa_rigor" | "runtime_portability";
...
export type RecontractReason = "missing_active_contract_frame" | "no_actionable_patch_ids" | "adapter_contract_drift" | "adapter_runtime_drift" | "repeated_same_failure_signature" | "release_gate_regression" | "scope_drift" | "manifest_contract_broken" | "plateau_without_progress" | "contradictory_evidence" | "patch_entropy_spike";
export type RoundVerdict = "advance" | "revise" | "hold";
export type RoundCheckStatus = "pass" | "fail" | "not_applicable";
export type RunStopReason = "target_reached" | "contract_completed" | "environment_blocked" | "adapter_contract_invalid" | "adapter_migration_rejected" | "new_run_required" | "awaiting_codex_checkpoint" | "awaiting_current_thread_handoff" | "awaiting_manual_generator" | "awaiting_human_input" | "awaiting_external_condition" | "plateau_limit_reached" | "max_rounds_reached";
export type RoundStopReason = RunStopReason | "continue";
export type RuntimeEventCode = "run.resumed_from_history" | "resume.recovered_round_checkpoint" | "resume.repaired_interrupted_round" | "resume.partial_init_rebuild" | "resume.migration_override" | "adapter.migration_applied" | "adapter.migration_accepted" | "adapter.migration_rejected" | "adapter.migration_new_run_requested" | "resume.noop_terminal" | "resume.reopened_terminal" | "resume.continued" | "validation.environment_lane_hint";
export type ValidationLane = "deterministic_semantic" | "environment_integration";
...
export type OperatorLaunchOrigin = "codex-app-thread" | "codex-automation" | "shell" | "supervisor" | "embedded-client";
export type OperatorSurfaceOwner = "stock-codex-thread" | "embedded-app-server" | "external-controller";
export type ThreadBindingState = "bound" | "assumed" | "unbound";
export type OperatorEntrypoint = "skill" | "plugin" | "shell" | "supervisor" | "automation" | "cli";
export type OperatorAppVisibility = "visible-in-stock-app" | "not-visible-in-stock-app" | "embedded-only";
export type OperatorHandoffState = "none" | "local" | "worktree" | "automation" | "manual" | "headless";
...
export type CurrentThreadCheckpointKind = "planner" | "contract-review" | "generator-plan" | "evaluator" | "attached-generator" | "adapter-migration-authoring" | "adapter-migration-approval";
...
export type OperatorRecommendedSkill = OperatorWorkerSkill | OperatorRecoverySkill;
export type CurrentThreadAutoContinueState = "codex_checkpoint" | "human_stop" | "external_stop" | "terminal";
export type OperatorPresentationMode = "foreground-thread" | "manual-protocol" | "background-automation" | "headless";
export type OperatorWorkspaceSurface = "local" | "worktree";
export type ExecutionState = "running" | "paused" | "stalled" | "failed" | "completed";
export type UiBindingMode = "embedded-app-server" | "stock-current-thread" | "none";
export type ControllerRoundPhase = "planning" | "negotiation" | "pre_verification" | "core_probes" | "post_verification" | "evaluation" | "round_commit" | "run_finalize";
export type ControllerPhaseStatus = "in_progress" | "completed" | "stalled" | "awaiting_codex_work" | "awaiting_human_input" | "awaiting_external_condition" | "awaiting_input";
...
export type FailureLineageTriggerCode = "environment_blocked" | "manifest_contract_broken" | "release_gate_regression" | "scope_drift" | "contradiction_detected" | "repeated_same_failure_signature" | "plateau_without_progress" | "patch_entropy_spike" | "stable_patch_authority";
export type FailureLineageClassification = "none" | "product_defect" | "environment_blocked" | "mixed";
...
export type AdapterDriftSignal = "static_contract_blockers" | "missing_target_manifest_keys";
export type AdapterOrigin = "generated_local" | "external_contract";
export type AdapterMigrationClass = "runtime_surface_patch" | "kernel_wiring_patch" | "boundary_break";
export type AdapterMigrationApplyMode = "same_run_in_place" | "proposal_only" | "new_run_required";
export type AdapterMigrationDecision = "accept" | "reject" | "open_new_run";
export type PatchRequestNextAction = RoundVerdict | "complete" | "recontract_adapter";
export type LifecycleDecisionSource = "initial_round" | "missing_active_contract_frame" | "no_actionable_patch_ids" | "hard_rule" | "policy_snapshot" | "default_patch_authority" | "trajectory_policy";
export type AdapterCapabilityName = "prepare_target" | "apply_change" | "run_target" | "capture_evidence" | "run_checks" | "grade_round";
export type ProofCapabilityName = "capture_evidence" | "run_checks" | "grade_round";
export type VerificationCriterionOperator = "equals" | "contains" | "regex" | "number_gte" | "number_lte";
export type QualityFindingSeverity = "critical" | "high" | "medium" | "low";
export type QualityFindingCategory = "workflow_completeness" | "interaction_clarity" | "error_recovery" | "persistence" | "consistency" | "reference_fit" | "proof_signal" | "subjective_quality";
export type RemediationStrategy = "tighten" | "refine" | "pivot";
export type TrajectoryMode = "tighten" | "refine" | "pivot" | "parallel_pivot";
export type TrajectoryRestartFrom = "current_head" | "last_stable" | "best_passing";
export type TrajectoryDecisionSource = "quality_critique" | "failure_policy" | "terminal_complete";
export type LiveVerificationMode = "browser" | "api" | "db" | "shell";
export type CoreVerificationProbeMode = "browser_journey" | "browser" | "http_json" | "http" | "file_contains" | "json_value" | "shell_command";
