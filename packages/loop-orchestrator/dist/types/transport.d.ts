import type { AdapterMigrationIdentitySnapshot, AdapterMigrationDecision, ControllerMode, ControllerPhaseStatus, ControllerRoundPhase, CurrentThreadAutoContinueState, CurrentThreadCheckpointKind, ExecutionState, ExecutorMode, OperatorAppVisibility, OperatorAttentionRequired, OperatorEntrypoint, OperatorForegroundOwner, OperatorHandoffState, OperatorLaunchOrigin, OperatorPresentationMode, OperatorRecoverySkill, OperatorRecommendedSkill, OperatorResumeSkill, OperatorSurfaceOwner, OperatorUiVisibility, OperatorWorkerSkill, OperatorWorkspaceSurface, RunStopReason, RuntimeEventCode, TargetFamily, ThreadBindingState, TransportMode, UiBindingMode, ValidationLane } from "./controller.js";
import type { EvalScoreDimension, ReleaseThresholdResults, RoundSummary } from "./evaluator.js";
...
export type CurrentThreadEnhancementStage = "planner" | "contract-review" | "generator-plan" | "evaluator";
...
export interface CurrentThreadAutoContinueContract {
    ...
    guard_reason?: "hop_limit_reached" | "checkpoint_loop_detected" | "checkpoint_no_progress" | "stale_checkpoint_response";
    notes?: string[];
}
...
export interface TransportStateArtifact {
    ...
    executor_mode?: ExecutorMode;
    updated_at: string;
    status: "configured" | "live" | "idle" | "completed" | "interrupted" | "blocked" | "closed";
    summary_path?: string;
    ...
    app_server?: {
        ...
        thread_id?: string;
        thread_name?: string;
        thread_lifecycle: "not_started" | "subscribed" | "unsubscribed" | "closed" | "archived" | "error";
        thread_runtime_status?: "notLoaded" | "idle" | "active" | "systemError";
        thread_active_flags?: string[];
        turn_id?: string;
        turn_status: "not_started" | "inProgress" | "completed" | "interrupted" | "failed" | "error";
...
export interface SupervisorStateArtifact {
    status: "launching" | "watching" | "restarting" | "paused" | "completed" | "failed" | "detached";
    launched_at: string;
    updated_at: string;
    owner_pid: number;
    controller_mode?: ControllerMode;
