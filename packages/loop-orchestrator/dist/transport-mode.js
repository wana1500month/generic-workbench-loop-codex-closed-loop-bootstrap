...
export const defaultTransportModeForControllerMode = (controllerMode) => controllerMode === "attached" ? "current-thread" : "codex-exec";
export const isTransportMode = (value) => typeof value === "string" &&
    transportModes.includes(value);
export const isCurrentThreadTransport = (transportMode) => transportMode === "current-thread" || transportMode === "app-server";
...
export const buildTransportStateArtifact = (input) => {
    ...
    return {
        ...
        ui_binding_mode: context.surfaceOwner === "embedded-app-server"
            ? "embedded-app-server"
...
//# sourceMappingURL=transport-mode.js.map