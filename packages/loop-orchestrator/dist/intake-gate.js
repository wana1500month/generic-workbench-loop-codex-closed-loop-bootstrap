...
const limitQuestions = (fields, locale) => fields
    ...
    switch (field.id) {
        ...
        case "target_root":
            return localizedQuestion(locale, "\uC791\uC5C5 \uD3F4\uB354\uAC00 \uC5B4\uB514\uC778\uC9C0 \uACBD\uB85C\uB97C \uADF8\uB300\uB85C \uC801\uC5B4\uC918.", "What is the working folder path?");
        case "target_score":
            return localizedQuestion(locale, "target score\uB97C 0~1 \uC0AC\uC774 \uC22B\uC790\uB85C \uC801\uC5B4\uC918. \uC608: 0.9", "What target score should the loop use between 0 and 1? Example: 0.9");
        case "max_rounds":
            return localizedQuestion(locale, "max rounds\uB97C \uBA87 \uBC88\uC73C\uB85C \uB458\uC9C0 \uC801\uC5B4\uC918. \uC608: 4", "How many max rounds should the loop use? Example: 4");
        case "run_command":
            return localizedQuestion(locale, "\uAE30\uC874 \uD504\uB85C\uC81D\uD2B8\uBA74 \uC2E4\uD589 \uBA85\uB839\uC744 \uC801\uC5B4\uC918. \uC608: npm run dev", "If this is an existing project, what run command should the loop use? Example: npm run dev");
        case "ready_url":
            return localizedQuestion(locale, "\uAE30\uC874 \uD504\uB85C\uC81D\uD2B8\uBA74 \uC900\uBE44 \uC644\uB8CC\uB97C \uD655\uC778\uD560 URL\uC744 \uC801\uC5B4\uC918. \uC608: http://127.0.0.1:3000/", "If this is an existing project, what ready URL should the loop check? Example: http://127.0.0.1:3000/");
