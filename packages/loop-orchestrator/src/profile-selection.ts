...
const targetFamilyMap = new Map<string, TargetFamilySelection>([
  [
    "generic-core",
    {
...
export const resolveTargetFamilySelection = (
  targetFamily?: string
): TargetFamilySelection | undefined => {
...
export const supportedTargetFamilies = (): TargetFamilySelection[] => {
  const seen = new Set<string>();
  const selections: TargetFamilySelection[] = [];
