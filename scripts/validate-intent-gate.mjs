...
assert.match(preparedProductBuildHumanOutput, /How should the loop verify this result/i);
assert.match(preparedProductBuildHumanOutput, /For each core workflow/i);
assert.doesNotMatch(preparedProductBuildHumanOutput, /ready_to_start/);
