...
const cliImport =
  "process.argv=[process.argv[0],'./packages/loop-orchestrator/dist/front-door-session-cli.js',...process.argv.slice(1)]; await import('./packages/loop-orchestrator/dist/front-door-session-cli.js')";
