...
const coreSuite = [
  ...
  "validate:source-release-identity",
  "validate:evaluator-freshness",
  "validate:evaluator-blind-context",
  "validate:no-evaluator-resume",
  "validate:carry-forward-gate-separated",
